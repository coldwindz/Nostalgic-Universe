...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="/harsh">Nostalgic Universe</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/harsh">Home</a>
        </li>
        <li class="nav-item">
      ...
      if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
        ...
        <p class="text-light py-2 my-1 mx-3">Welcome_'. $_SESSION['useremail']. ' </p>
        <a href="partials/_logout.php" <button class="btn btn-outline-success ml-2 my-1" > Logout </button> </a>
        </form>';
      }
      else{
